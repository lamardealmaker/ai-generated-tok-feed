...
class ScriptAgent(BaseAgent):
    ...
    def __init__(self):
        # No template-based generation; relies solely on OpenAI for script generation.
        pass
    ...
    def generate_script(self, property_data: Dict[str, Any], style: str = "modern", duration: float = 30.0) -> Dict[str, Any]:
        ...
        """
        # Construct prompt using property details
        prompt = (
            ...
            "in a coherent manner, without using hyperbolic language or repeated phrases. It should be suitable for a voiceover narration "
